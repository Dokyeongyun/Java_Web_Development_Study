...
%>
--%>
<%--[고객 지원 어플리케이션 Version 6 : 템플릿 태그파일 이용한 자바 코드 대체 + 날짜 서식지정 커스텀 태그 사용--%>
<template:basic htmlTitle="${ticket.subject}" bodyTitle="티켓 #${ticketId}: ${ticket.subject}">

    <i>고객 이름: <c:out value="${ticket.customerName}"/><br>
    생성일시 <dft:formatDate value="${ticket.dateCreated}" type="both"
...
<%--로그아웃--%>
<%--
<a href="<c:url value="/login?logout" />">로그아웃</a><br><br><br>
--%>
