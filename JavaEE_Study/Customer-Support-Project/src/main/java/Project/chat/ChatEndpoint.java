...
public class ChatEndpoint implements HttpSessionListener {
    ...
    public void onOpen(Session session, @PathParam("sessionId") long sessionId) {
        ...
        try {
            ...
            if(sessionId < 1) {
                // 새로운 세션이 요청된 경우 새 채팅 세션 생성 및 대기 중 세션 목록에 추가
    ...
    /**
     * 사용자가 채팅을 종료한 경우 메시지 출력 및 채팅방 제거
     */
    @OnClose
    ...
    /**
     * 채팅 중 에러발생 시 메시지 출력 및 채팅방 제거, 세션 종료
     */
    @OnError
    ...
    /**
     * 세션이 종료될 때 호출되어 세션을 로그 기록을 추가하고 세션을 종료
     */
    @Override
    ...
    public static class EndpointConfigurator extends ServerEndpointConfig.Configurator {
        ...
        public void modifyHandshake(ServerEndpointConfig config, HandshakeRequest request, HandshakeResponse response) {
            ...
            // 핸드셰이크 중에 호출되어 HTTP요청을 노출
            // HttpSession 객체를 얻을 수 있음
